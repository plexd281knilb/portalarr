...
function Button<P extends ElementTypes = 'button'>(
  ...
  switch (buttonType) {
    case 'primary':
      buttonStyle.push(
        'text-white border border-orange-500 bg-orange-500 bg-opacity-80 hover:bg-opacity-100 hover:border-orange-500 focus:border-orange-500 focus:ring-orange active:bg-opacity-100 active:border-orange-500'
      );
      break;
    case 'danger':
      buttonStyle.push(
    ...
    case 'warning':
      buttonStyle.push(
        'text-white border border-orange-400 bg-orange-500 bg-opacity-80 hover:bg-opacity-100 hover:border-orange-300 focus:border-orange-500 focus:ring-orange active:bg-opacity-100 active:border-orange-500'
      );
      break;
    case 'success':
      buttonStyle.push(
    ...
    default:
      buttonStyle.push(
        'text-gray-200 bg-stone-800 bg-opacity-80 border-gray-600 hover:text-white hover:bg-gray-700 hover:border-gray-600 group-hover:text-white group-hover:bg-gray-700 group-hover:border-gray-600 focus:border-orange-300 focus:ring-orange active:text-gray-200 active:bg-gray-700 active:border-gray-600'
      );
  }
