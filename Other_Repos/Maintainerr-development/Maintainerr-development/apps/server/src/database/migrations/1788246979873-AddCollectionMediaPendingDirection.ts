...
export class AddCollectionMediaPendingDirection1788246979873 implements MigrationInterface {
  name = 'AddCollectionMediaPendingDirection1788246979873';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
            CREATE TABLE "temporary_collection_media_rule_removal" (
                ...
                "direction" varchar NOT NULL DEFAULT ('remove'),
